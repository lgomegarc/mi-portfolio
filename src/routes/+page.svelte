    ...
    <div class="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div class="container py-24 text-center">
            ...
            <p class="text-xl sm:text-2xl max-w-2xl mx-auto mb-10 text-gray-200"
                ...
                Bienvenid@ a mi portafolio. Aquí muestro mis <a href="#projects" class="text-cyan-400 font-bold ">proyectos</a>, <a href="#about" class="text-cyan-400 font-bold">habilidades</a> y el camino que sigo como desarrolladora backend.
            </p>
            <a href="#about" 
